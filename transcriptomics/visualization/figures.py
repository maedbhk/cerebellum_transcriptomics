...
class Main(Utils):
    ...
    def fig_1(self, atlas='MDTB-10', which_genes='top', percentile=1, remove_outliers=True, normalize=True):
        """
    ...
    def fig_2(self, which_genes='top', percentile=1, remove_outliers=True, reorder_labels=True, atlas_other="MDTB-10", normalize=True):
        plt.clf()
        ...
        ax4.tick_params(axis='x', which='major', labelsize=20)
        ax4.tick_params(axis='y', which='major', labelsize=20)
        ax4.text(x_pos-.16, y_pos, 'D', transform=ax4.transAxes, fontsize=50,
        verticalalignment='top')
        ax4.yaxis.label.set_size(30)
    ...
    def fig_3(self, atlas='SUIT-10', which_genes='top', percentile=1, remove_outliers=True, atlas_other="MDTB-10", normalize=True):
        # plt.clf()
    ...
    def fig_4(self, image1="rat_zones", image2="MDTB-10-subRegions-transcriptomic", atlas='MDTB-10-subRegions', which_genes='top', percentile=1, remove_outliers=True, atlas_other="MDTB-10", normalize=True):
        plt.clf()
...
class Supp(Utils):
    ...
    def supp_1(self, which_genes='top', percentile=1, remove_outliers=True, atlas_other="MDTB-10", normalize=True):
        plt.clf()
        ...
        ax6.tick_params(axis='x', which='major', labelsize=40)
        ...
        ax8.tick_params(axis='x', which='major', labelsize=25)
    ...
    def supp_2(self, atlas="SUIT-10", which_genes='top', percentile=1, remove_outliers=True, atlas_other="MDTB-10", normalize=True):
        plt.clf()
    ...
    def supp_3(self, atlas="SUIT-26", which_genes='top', percentile=1, remove_outliers=True, atlas_other="MDTB-10", normalize=True):
    ...
    def supp_4(self, atlas1="MDTB-10-subRegions", atlas2="SUIT-10", which_genes='top', atlas_other="MDTB-10", percentile=1, classifier='logistic', remove_outliers=True, normalize=True):
        plt.clf()
    ...
    def supp_5(self, atlas1='SUIT-10', atlas2='MDTB-10-subRegions', which_genes='top', atlas_other="MDTB-10", percentile=1, model_type='linear', label_type='multi-class', normalize=True):
        plt.clf()
    ...
    def supp_6(self, atlas='SUIT-10', which_genes='top', atlas_other="MDTB-10", percentile=1, remove_outliers=True, normalize=True):
        """ save gene table
        """
        plt.clf()
